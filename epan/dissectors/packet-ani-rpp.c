        ...
        gint header, guint8 headerLength, const char *title)
{
    ...
    if (tree) {
        proto_tree_add_item(tree, hf_ani_rpp_next_header_type, tvb, *offset, 1, ENC_NA);
        proto_tree_add_item(tree, hf_ani_rpp_header_length, tvb, *offset+1, 1, ENC_NA);
    }
...
dissect_responder_header(tvbuff_t *tvb, packet_info *pinfo, proto_tree *ani_rpp_tree, void *data)
{
    ...
    while (currentHeader != HDR_LAST && currentHeader < HDR_INVALID) {
        ...
        case HDR_SEQUENCE:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_pkt_id, tvb, offset, 4, ENC_NA);
        ...
        case HDR_ERROR:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Error Header");
            proto_tree_add_item(current_tree, hf_ani_rpp_error_code, tvb, offset, 1, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_error_value, tvb, offset+1, 1, ENC_NA);
        ...
        case HDR_FLOW_CREATE:
            ...
            if (headerLength >= 6) {
                proto_tree_add_item(current_tree, hf_ani_rpp_flow_port_first, tvb, offset, 2, ENC_NA);
                proto_tree_add_item(current_tree, hf_ani_rpp_flow_port_last, tvb, offset+2, 2, ENC_NA);
            } else {
                proto_tree_add_item(current_tree, hf_ani_rpp_flow_port, tvb, offset, 2, ENC_NA);
            }
        ...
        case HDR_FLOW_RESPONSE:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_flow_num, tvb, offset, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_flow_port, tvb, offset+4, 2, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_response_status, tvb, offset+6, 2, ENC_NA);
        ...
        case HDR_TEST_WEIGHT:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_test_weight, tvb, offset, 2, ENC_NA);
        ...
        case HDR_RESPONDERVERSION:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_responder_version_major, tvb, offset, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_responder_version_minor, tvb, offset+4, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_responder_version_revision, tvb, offset+8, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_responder_version_build, tvb, offset+12, 4, ENC_NA);
        ...
        case HDR_COMMAND_INFO:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_first_id, tvb, offset, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_burst_size, tvb, offset+4, 2, ENC_NA);
            if (headerLength > 8) {
                proto_tree_add_item(current_tree, hf_ani_rpp_packet_size, tvb, offset+6, 2, ENC_NA);
            }
            if (headerLength >= 11) {
                proto_tree_add_item(current_tree, hf_ani_rpp_command_type, tvb, offset+8, 1, ENC_NA);
        ...
        case HDR_OUTBOUNDARRIVAL:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_outbound_arrival_bits, tvb, offset, 8, ENC_NA);
        ...
        case HDR_RESPONDERHOLDTIME:
            ...
            proto_tree_add_item(current_tree, hf_ani_burst_hold_time_us, tvb, offset, 4, ENC_NA);
        ...
        case HDR_OUTBOUNDARRIVALTIME:
            ...
            for (; i<depth; i+=4) {
                proto_tree_add_item(current_tree, hf_ani_rpp_outbound_arrival_times, tvb, offset+i, 4, ENC_NA);
            }
            break;
        case HDR_LOST_PACKETS:
            ...
            depth = headerLength - 2;
            for (i=0; i<depth; i+=4) {
                proto_tree_add_item(current_tree, hf_ani_rpp_lost_id, tvb, offset+i, 4, ENC_NA);
            }
        ...
        case HDR_SIPPORT:
        {
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_sipport, tvb, offset, 2, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ta_id, tvb, offset + 2, idLength, ENC_ASCII);
            break;
        }
        case HDR_PROTOCOL:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Protocol");
            proto_tree_add_item(current_tree, hf_ani_rpp_protocol, tvb, offset, 4, ENC_NA);
            break;
        ...
        case HDR_CONTROLLEDBURSTRESPONSE:
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_cb_resp_ratelimitcbrate, tvb, offset, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_cb_resp_minpacketcount, tvb, offset+4, 4, ENC_NA);
            break;
        case HDR_INBOUNDPACKETATTR:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Inbound Packet Attributes");
            proto_tree_add_item(current_tree, hf_ani_rpp_inboundpacketcount, tvb, offset, 2, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_inboundpacketsize, tvb, offset+2, 2, ENC_NA);
        ...
        case HDR_H323PORT:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "H.323");
            proto_tree_add_item(current_tree, hf_ani_rpp_h323port, tvb, offset, 2, ENC_NA);
            break;
        case HDR_APPLIANCE_TYPE:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Device Type");
            proto_tree_add_item(current_tree, hf_ani_rpp_appliance_type, tvb, offset, 1, ENC_NA);
            break;
        case HDR_CUSTOM_TYPE:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Custom Type");
            proto_tree_add_item(current_tree, hf_ani_rpp_custom_appliance_type, tvb, offset, headerLength - 2, ENC_ASCII);
            break;
        case HDR_CONTROLLEDBURSTREADY:
            col_append_fstr(pinfo->cinfo, COL_INFO, " Controlled Burst Ready");
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Controlled Burst Ready");
            proto_tree_add_item(current_tree, hf_ani_rpp_cb_ready_reserved1, tvb, offset, 1, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_cb_ready_reserved2, tvb, offset+1, 1, ENC_NA);
            break;
        case HDR_CONTROLLEDBURSTREQUEST:
            col_append_fstr(pinfo->cinfo, COL_INFO, " Controlled Burst Request");
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Controlled Burst Request");
            proto_tree_add_item(current_tree, hf_ani_rpp_cb_request_reserved1, tvb, offset, 1, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_cb_request_reserved2, tvb, offset+1, 1, ENC_NA);
            break;
        case HDR_ECBREQUEST:
        {
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_padding, tvb, offset, 1, ENC_NA);
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_ssn, tvb, offset+2, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_outbound_magnify, tvb, offset+6, 2, ENC_NA);
            col_append_fstr(pinfo->cinfo, COL_INFO, " ECB out[mag=%u", tvb_get_ntohs(tvb, offset+6));
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_outbound_duration, tvb, offset+8, 2, ENC_NA);
            col_append_fstr(pinfo->cinfo, COL_INFO, " dur=%ums", tvb_get_ntohs(tvb, offset+8));
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_outbound_gap, tvb, offset+10, 2, ENC_NA);
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_inbound_magnify, tvb, offset+12, 2, ENC_NA);
            col_append_fstr(pinfo->cinfo, COL_INFO, " in[mag=%u", tvb_get_ntohs(tvb, offset+12));
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_inbound_duration, tvb, offset+14, 2, ENC_NA);
            col_append_fstr(pinfo->cinfo, COL_INFO, " dur=%ums", tvb_get_ntohs(tvb, offset+14));
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_inbound_gap, tvb, offset+16, 2, ENC_NA);
            col_append_fstr(pinfo->cinfo, COL_INFO, " gap=%uus", tvb_get_ntohs(tvb, offset+16));
            if (headerLength > 20) {
                proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_outbound_max_packets, tvb, offset+18, 4, ENC_NA);
                proto_tree_add_item(current_tree, hf_ani_rpp_ecb_request_inbound_max_packets, tvb, offset+22, 4, ENC_NA);
        ...
        case HDR_ECBRESPONSE:
        {
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_padding, tvb, offset, 1, ENC_NA);
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_first_tx_ts, tvb, offset+2, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_first_rx_ts, tvb, offset+6, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_ll_rx, tvb, offset+10, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_ll_rx_bytes, tvb, offset+14, 8, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_ll_us, tvb, offset+22, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_total_rx, tvb, offset+26, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_total_rx_bytes, tvb, offset+30, 8, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_outbound_total_us, tvb, offset+38, 4, ENC_NA);
            if (final_results) {
            ...
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_first_tx_ts, tvb, offset+42, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_first_rx_ts, tvb, offset+46, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_ll_rx, tvb, offset+50, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_ll_rx_bytes, tvb, offset+54, 8, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_ll_us, tvb, offset+62, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_total_rx, tvb, offset+66, 4, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_total_rx_bytes, tvb, offset+70, 8, ENC_NA);
            proto_tree_add_item(current_tree, hf_ani_rpp_ecb_resp_inbound_total_us, tvb, offset+78, 4, ENC_NA);
            if (in_avail) {
        ...
        case HDR_SIGNATURE:
            ...
            if (headerLength > 6) {
                ...
                proto_tree_add_item(current_tree, hf_ani_rpp_signature_burst_len, tvb, offset+6, 4, ENC_NA);
                proto_tree_add_item(current_tree, hf_ani_rpp_signature_iht, tvb, offset+10, 4, ENC_NA);
            } else {
                /* this is a single-ended or ICMP extended packet signature found in payload */
                proto_tree_add_item(current_tree, hf_ani_rpp_signature_iht, tvb, offset, 4, ENC_NA);
            }
            break;
        case HDR_PSEUDO_CKSUM:
                current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                        "Pseudo Checksum");
                tf = proto_tree_add_item(current_tree, hf_ani_rpp_pseudo_chksum, tvb, offset, 2, ENC_NA);
        ...
        default:
            current_tree = add_subtree(tvb, &offset, current_tree, currentHeader, headerLength,
                    "Unknown Header");
            tf = proto_tree_add_item(current_tree, hf_ani_rpp_unknown_header, tvb, offset, headerLength-2, ENC_NA);
...
dissect_ani_rpp(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
    ...
    ti = proto_tree_add_item(tree, proto_ani_rpp, tvb, 0, offset, ENC_NA);
...
void proto_register_ani_rpp(void)
{
    ...
    static hf_register_info hf[] = {
            ...
            },
            {
                    ...
                    {
                            "Major",
                            "ani-rpp.responder_version_major",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "Minor",
                            "ani-rpp.responder_version_minor",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "Revision",
                            "ani-rpp.responder_version_revision",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "Build",
                            "ani-rpp.responder_version_build",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_inbound_packetcount,
                    {
                            ...
                            "ani-rpp.cb_inbound_packet_count",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_inbound_interpacketgap,
                    {
                            ...
                            "ani-rpp.cb_inbound_interpacket_gap",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_outbound_packetcount,
                    {
                            ...
                            "ani-rpp.cb_outbound_packet_count",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_outbound_interpacketgap,
                    {
                            ...
                            "ani-rpp.cb_outbound_interpacket_gap",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "Rate Limit CB Rate",
                            "ani-rpp.cb_resp_ratelimit_cb_rate",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_resp_minpacketcount,
                    {
                            ...
                            "ani-rpp.cb_resp_min_packet_count",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_request_reserved1,
                    {
                            ...
                            "ani-rpp.cb_resp_ratelimit_cb_request_reserved1",
                            FT_UINT8,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_request_reserved2,
                    {
                            ...
                            "ani-rpp.cb_resp_ratelimit_cb_request_reserved2",
                            FT_UINT8,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_ready_reserved1,
                    {
                            ...
                            "ani-rpp.cb_resp_ratelimit_cb_ready_reserved1",
                            FT_UINT8,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_cb_ready_reserved2,
                    {
                            ...
                            "ani-rpp.cb_resp_ratelimit_cb_ready_reserved2",
                            FT_UINT8,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "Is First sequence",
                            "ani-rpp.ecb_request_flags.first",
                            FT_BOOLEAN,
                            8,
            ...
            },
            {
                    ...
                    {
                            "Is Last sequence",
                            "ani-rpp.ecb_request_flags.last",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x02,
            ...
            },
            {
                    ...
                    {
                            "Is Reply",
                            "ani-rpp.ecb_request_flags.reply",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x04,
            ...
            },
            {
                    ...
                    {
                            "RX Report All",
                            "ani-rpp.ecb_request_flags.report_all",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x08,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_flags_inbound_gap_ns,
                    {
                            ...
                            "ani-rpp.ecb_request_flags.inbound_gap_nanoseconds",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x10,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_flags_outbound_gap_ns,
                    {
                            ...
                            "ani-rpp.ecb_request_flags.outbound_gap_nanoseconds",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x20,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_outbound_magnify,
                    {
                            ...
                            "ani-rpp.ecb_request_outbound_magnify",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_outbound_duration,
                    {
                            ...
                            "ani-rpp.ecb_request_outbound_duration",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_outbound_gap,
                    {
                            ...
                            "ani-rpp.ecb_request_outbound_gap",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_inbound_magnify,
                    {
                            ...
                            "ani-rpp.ecb_request_inbound_magnify",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_inbound_duration,
                    {
                            ...
                            "ani-rpp.ecb_request_inbound_duration",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_inbound_gap,
                    {
                            ...
                            "ani-rpp.ecb_request_inbound_gap",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_outbound_max_packets,
                    {
                            ...
                            "ani-rpp.ecb_request_outbound_max_packets",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_request_inbound_max_packets,
                    {
                            ...
                            "ani-rpp.ecb_request_inbound_max_packets",
                            FT_UINT16,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_first_tx_ts,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_first_tx_ts",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_first_rx_ts,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_first_rx_ts",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_ll_rx,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_ll_rx",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_ll_rx_bytes,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_ll_rx_bytes",
                            FT_UINT64,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_ll_us,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_ll_us",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_total_rx,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_total_rx",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_total_rx_bytes,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_total_rx_bytes",
                            FT_UINT64,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_outbound_total_us,
                    {
                            ...
                            "ani-rpp.ecb_resp_outbound_total_us",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_first_tx_ts,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_first_tx_ts",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_first_rx_ts,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_first_rx_ts",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_ll_rx,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_ll_rx",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_ll_rx_bytes,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_ll_rx_bytes",
                            FT_UINT64,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_ll_us,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_ll_us",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_total_rx,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_total_rx",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_total_rx_bytes,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_total_rx_bytes",
                            FT_UINT64,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_ecb_resp_inbound_total_us,
                    {
                            ...
                            "ani-rpp.ecb_resp_inbound_total_us",
                            FT_UINT32,
                            BASE_DEC,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "Undefined signature",
                            "ani-rpp.signature.undefined_signature",
                            FT_BYTES,
                            BASE_NONE,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_signature_legacy,
                    {
                            ...
                            "ani-rpp.signature.legacy_signature",
                            FT_BYTES,
                            BASE_NONE,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_signature_path,
                    {
                            ...
                            "ani-rpp.signature.path_signature",
                            FT_BYTES,
                            BASE_NONE,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_signature_path_reply,
                    {
                            ...
                            "ani-rpp.signature.path_reply_signature",
                            FT_BYTES,
                            BASE_NONE,
                            NULL,
                            0x0,
            ...
            },
            {
                    &hf_ani_rpp_signature_pathtest,
                    {
                            ...
                            "ani-rpp.signature.pathtest_signature",
                            FT_BYTES,
                            BASE_NONE,
                            NULL,
                            0x0,
            ...
            },
            {
                    ...
                    {
                            "First packet",
                            "ani-rpp.signature.path_flags.first",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x10,
            ...
            },
            {
                    ...
                    {
                            "Last packet",
                            "ani-rpp.signature.path_flags.last",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x20,
            ...
            },
            {
                    &hf_ani_rpp_signature_flags_iht,
                    {
                            ...
                            "ani-rpp.signature.path_flags.iht",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x40,
            ...
            },
            {
                    ...
                    {
                            "Extended Headers",
                            "ani-rpp.signature.path_flags.ext_hdr",
                            FT_BOOLEAN,
                            8,
                            TFS(&ani_tf_set_not_set),
                            0x80,
